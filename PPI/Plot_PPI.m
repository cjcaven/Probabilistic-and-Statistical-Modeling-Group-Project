...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-001/PPI/PPI-Stim-Img/PPI_OP4-right_Stim-Img.mat');
...
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-001/PPI/PPI-Img-Stim/PPI_OP4-right_Img-Stim.mat');
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-002/PPI/PPI_OP4-right_Img-Stim.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-002/PPI/PPI_OP4-right_Stim-Img.mat');
%sub3
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-003/PPI/PPI_OP4-right_Img-Stim_sub003.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-003/PPI/PPI_OP4-right_Stim-Img.mat');
%sub4
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-004/PPI/PPI_OP4-right_Img-Stim_sub004.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-004/PPI/PPI_OP4-right_Stim-Img.mat');
%sub5
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-005/PPI/PPI_OP4-right_Img-Stim_sub005.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-005/PPI/PPI_OP4-right_Stim-Img.mat');
%sub6
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-006/PPI/PPI_OP4-right_Img-Stim_sub006.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-006/PPI/PPI_OP4-right_Stim-Img.mat');
%sub7
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-007/PPI/PPI_OP4-right_Img-Stim.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-007/PPI/PPI_OP4-right_Stim-Img.mat');
%sub8
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-008/PPI/PPI_OP4-right_Img-Stim.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-008/PPI/PPI_OP4-right_Stim-Img.mat');
%sub9
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-009/PPI/PPI_OP4-right_Img-Stim.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-009/PPI/PPI_OP4-right_Stim-Img.mat');
%sub10
...
stim_img_op4_r = load('/Volumes/LP2/Stats23_data/sub-010/PPI/PPI_OP4-right_Img-Stim.mat');
img_stim_op4_r = load('/Volumes/LP2/Stats23_data/sub-010/PPI/PPI_OP4-right_Stim-Img.mat');

% Plot Figure

figure
plot(img_stim_threeb_r.PPI.ppi,img_stim_op4_r.PPI.ppi,'k.');
hold on
plot(stim_img_threeb_r.PPI.ppi,stim_img_op4_r.PPI.ppi,'r.');

% Plot the best fit lines for Img>Stim PPI
x = img_stim_threeb_r.PPI.ppi(:);
x = [x, ones(size(x))];
y = img_stim_op4_r.PPI.ppi(:);
B = x\y;
y1 = B(1)*x(:,1)+B(2);
plot(x(:,1),y1,'k-');

% Plot the best fit line for Stim>Img PPI
x = stim_img_threeb_r.PPI.ppi(:);
x = [x, ones(size(x))];
y = stim_img_op4_r.PPI.ppi(:);
B = x\y;
y1 = B(1)*x(:,1)+B(2);
plot(x(:,1),y1,'r-');
...
saveas(gcf, '/Users/lp1/Documents/GitHub/Probabilistic-and-Statistical-Modeling-Group-Project/PPI/Figures/figure_sub001.png');
